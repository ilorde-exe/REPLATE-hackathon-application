...
const page = () => {
  return (
    <div className="px-6 py-2 mt-8 font-serif">
      <p className="p-4 rounded-xl shadow-lg border-2 border-amber-100">
        <h1 className="text-2xl text-bold">About Us</h1>
        <br />
        Welcome to Replate, where hope meets action through the power of sharing
        food.
        <br />
        <br />
        At Replate, we believe in the transformative potential of connecting
        surplus food from events with those in need. In a world where food waste
        persists alongside hunger, Replate serves as a beacon of hope, offering
        ...
        managers and charitable organizations, Replate streamlines the process
        of food donation, making it swift, seamless, and impactful. Our mission
        is simple yet profound: to reduce food waste, alleviate hunger, and
